...
[dieser Seite](https://github.com/jbschulte/R-Tutorium-Installation) 
...
`Installation.Rproj`.
3. Öffnen Sie die Datei `Installation_Skript.Rmd` in R-Studio, in dem Sie die Datei
im Fenster `files` rechts unten auswählen.
4. Folgen Sie den Anweisungen im Skript. Für die Installation müssen Sie
